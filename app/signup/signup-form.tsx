        ...
        <Card className="p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-center text-sm text-foreground/60">
              ...
              <Link href={`/login${searchParams.get('next') ? `?next=${encodeURIComponent(searchParams.get('next') as string)}` : ''}`} className="text-primary hover:text-primary/80 font-medium">
                Sign in
              </Link>
            </p>
          </form>
